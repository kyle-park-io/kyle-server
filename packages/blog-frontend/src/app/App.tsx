      ...
      <div class="home-container">
        ...
        <section class="home-section">
          ...
          <div class="home-grid home-grid--3 introduce-grid-bottom">
            {/* An <a>, not a button: /blog is served by express, and
                @solidjs/router intercepts same-origin clicks unless told the
                target is external. */}
            <a class="project-card" href="/blog" rel="external">
              <span class="project-card__icon">📝</span>
